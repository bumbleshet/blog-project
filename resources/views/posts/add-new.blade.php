		  		...
		  		<div class="panel-body">
		  			{!! Form::open() !!}
		  				<div class="form-group @if($errors->has('title')) has-error @endif">
							...
							{!! Form::text('title', '', ['class' => 'form-control', 'id' => 'txtTitle', 'placeholder' => 'The Title of your Blog Post']) !!}
						</div>
						<div class="form-group @if($errors->has('body')) has-error @endif">
							<label class="control-label">@if($errors->has('body')) {{$errors->first('body')}} @else Body @endif</label>
							{!! Form::textarea('body', '', ['class' => 'form-control', 'id' => 'txtBody', 'placeholder' => 'The Content of your Blog Post', 'style' => 'height: 100px;']) !!}
						</div>
